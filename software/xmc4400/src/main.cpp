...
int main()
{
    ...
    TRACECLK.set(XMC_GPIO_OUTPUT_STRENGTH_STRONG_MEDIUM_EDGE);
    LED0.set(XMC_GPIO_HWCTRL_PERIPHERAL1);
    LED0.set(XMC_GPIO_OUTPUT_STRENGTH_STRONG_MEDIUM_EDGE);
    LED1.set(XMC_GPIO_HWCTRL_PERIPHERAL1);
    LED1.set(XMC_GPIO_OUTPUT_STRENGTH_STRONG_MEDIUM_EDGE);
    LED2.set(XMC_GPIO_HWCTRL_PERIPHERAL1);
    LED2.set(XMC_GPIO_OUTPUT_STRENGTH_STRONG_MEDIUM_EDGE);
    LED3.set(XMC_GPIO_HWCTRL_PERIPHERAL1);
    LED3.set(XMC_GPIO_OUTPUT_STRENGTH_STRONG_MEDIUM_EDGE);
    tpi.CSPSR=8;
    tpi.SPPR=0;
    tpi.FFCR=0;
    dwt.CTRL=0x40010001;
